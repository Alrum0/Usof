    ...
    return (
      <section className='ml-0 md:ml-20 fixed inset-0 z-50'>
        <div
          ...
          onClick={onClose}
        />
        <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-[var(--color-background-profile)] rounded-lg border border-[var(--color-border)] w-[95%] md:w-[70%] lg:w-[48%] overflow-x-hidden'>
          <div className='px-4 md:px-8 py-4 flex items-center justify-center'>
